...
void quad( int a, int b, int c, int d )
{
	...
	Index++;
    colors[Index] = vertex_colors[a]; points[Index] = vertices[c]; tex_coords[Index] = vec2( 2.0, 1.0 );
	Index++;
    colors[Index] = vertex_colors[a]; points[Index] = vertices[a]; tex_coords[Index] = vec2( 0.0, 0.0 );
	Index++;
    colors[Index] = vertex_colors[a]; points[Index] = vertices[c]; tex_coords[Index] = vec2( 2.0, 1.0 );
	Index++;
    colors[Index] = vertex_colors[a]; points[Index] = vertices[d]; tex_coords[Index] = vec2( 2.0, 0.0 );
	Index++;
}
